...
object ClientOffsets {
    ...
    val dwSensitivity by clientDLL(2, 44)(
        0x81, 0xF9, 0[4], 0x75, 0x1D, 0xF3, 0x0F, 0x10, 0x05, 0[4], 0xF3, 0x0F, 0x11, 0x44, 0x24,
        0, 0x8B, 0x44, 0x24, 0x0C, 0x35, 0[4], 0x89, 0x44, 0x24, 0x0C
    )
    ...
    val pStudioHdr by clientDLL(2, subtract = false)(
        0x8B, 0xB6, 0[4], 0x85, 0xF6, 0x74, 0x05, 0x83, 0x3E, 0[1], 0x75, 0x02, 0x33, 0xF6, 0xF3, 0x0F, 0x10, 0x44, 0x24
    )
}
